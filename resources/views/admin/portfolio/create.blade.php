...
<section class="content">
    <form method="POST" action="{{route('portfolio.store')}}" enctype="multipart/form-data" class="row">
      @csrf
      <div  class="col-md-6">
          ...
          <div class="card-body">
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="deadline"  id="inputClientCompany" class="form-control">
                </div>
                <div class="form-group">
